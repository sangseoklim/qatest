...
# 공급사 계정으로 발주확정 하기
driver.get ('https://partner.kurly.com/#/loginn')
driver.find_element_by_id('inputEmail').send_keys ('VD2008.02')
...
# -------------- RMS start ---------------
# 페이지 접근 후 타이틀명을 검증함
driver.get ('https://m.rms.kurly.com/')
...
# 입하 확정 조회
driver.get('https://m.rms.kurly.com/#/dashboard/receiving/receivedList')
time.sleep(1)
...
# 검품 완료 조회
driver.get('https://m.rms.kurly.com/#/dashboard/inspection/inspectedList')
time.sleep(1)
driver.find_element_by_xpath('/html/body/div/div/main/div/div/div/div/div/div/div/div[1]/div/input').send_keys(Pom)
time.sleep(1)
driver.find_element_by_xpath('/html/body/div/div/main/div/div/div[1]/div/div/div/div/div[1]/div/input').send_keys(Keys.RETURN)
...
# 입하관리 페이지 이동
driver.get ('https://web.rms.kurly.com/#/receiving/list')
